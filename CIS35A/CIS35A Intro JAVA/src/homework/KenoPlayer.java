 ...
 Description: 
 Homework 6 KenoPlayer: This object holds the player's data. It contains the
...
public class KenoPlayer {
	...
	public KenoPlayer(int numSpots, int bet){
		if((numSpots > 0) && (numSpots <= KenoGame.payoffAmounts.length)){
	...
	public boolean setSpot(Spot input){
	...
	public void calcWinnings(){
		...
		double payoff = KenoGame.payoffAmounts[marked][numMatches];
	...
	public String toString(){
		...
		PlayerData.append("\nPlayer matched "+numMatches+" spot(s)"+", bet $"+playerBet
				+" and won $"+playerWinnings+"\n");
