 ...
 Description: 
 Homework 6 KenoGame: This object contains the data for the Keno Game.
...
public class KenoGame implements NumberGameInterface {
	...
	private static KenoBoard gameGrid;
	private static KenoPlayer user;
	
	public KenoGame(){
		gameGrid = new KenoBoard(); 
	}
	public void initKenoPlayer(int num1, int num2){
		user = new KenoPlayer(num1,num2);
	}
